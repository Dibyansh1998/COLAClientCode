...
public class Go_TO_HomePage_COLA {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("USERNAME")).sendKeys("911317004");
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//button[@class='btn btn-primary mr-10'])[1]")));
