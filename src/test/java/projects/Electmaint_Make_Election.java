...
@Test(groups="MakeElectionClass")
public class Electmaint_Make_Election {

	public void TakeMakeElectionScreenShot() throws InterruptedException, IOException {
...
//				{ "911316466", "Test@1234" }, // 911316466:TSPPGN
		...
		for (String[] credential : credentials) {
			...
			WebElement ele = wait.until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath("//div[@class='row makeElectionPageRow ng-scope']//div[@class='row']")));
